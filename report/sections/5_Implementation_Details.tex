...
\begin{itemize}
    ...
    \item \textbf{Problem data}: symbolic mathematical expressions for $c(\mathbf{x})$, $f(\mathbf{x},t)$, $u_0(\mathbf{x})$, $v_0(\mathbf{x})$, $g(\mathbf{x},t)$, $\partial_t g(\mathbf{x},t)$, and optionally the exact solution.
